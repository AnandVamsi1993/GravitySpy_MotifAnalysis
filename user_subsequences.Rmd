...
# 
# userW4W5 <- userW4W5 %>%
#   mutate(total_subsequeces = rowSums(.[1:257])) %>%
#   rowwise() %>% 
#   mutate(unique_subsequeces = 257 - sum(c_across(1:257) == 0))
# 
# userW4W5 <- data.frame(userW4W5)
# userW4W5$Status2 <- ifelse(userW4W5$Status=="Promoted",1,0)
# 
# 
# userW4W5$richness <- as.numeric(richness(userW4W5[1:257], method = "margalef")) 
# userW4W5_richness <- na.omit(userW4W5) 
# wilcox.test(userW4W5_richness$richness,userW4W5_richness$Status2)
# 
# userW4W5$rarefaction <- as.numeric(composition(userW4W5[1:257], method = "chao1")) 
...
#userworkflows <- rbind(userW1W2[,c(22:29)],userW2W3[,c(43:50)],userW3W4[,c(300:307)],userW4W5[258:365])
...
# W4W5_summary <-  userworkflows[,c(1,6,7,8)] %>%
